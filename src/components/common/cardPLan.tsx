    ...
    <div className="mt-5 w-full flex flex-wrap items-start gap-8">
      <div
        ...
        style={{
          ...
          boxShadow: `0 1px 32px rgba(174,172,243,0.35)`,
        }}
      >
        {recommended && (
          <div className="absolute text-xs ml-2 top-10 left-4 bg-mintGreen font-bold px-3 py-1 rounded-[6px]">
        ...
        <div className="flex-1">
          <div className="w-full grid grid-cols-[1fr_56px] items-start gap-4">
            <div className="flex flex-col">
              <p
                className="text-2xl font-bold leading-8 tracking-[-0.2px]"
                style={{ color: COLORS.darkBlue1 }}
              >
                {name}
              </p>
              <p
              ...
              <span
                className="text-xl font-bold leading-7 tracking-[-0.2px]"
                style={{ color: COLORS.darkBlue1 }}
              >
                ${price} al mes
              </span>
          ...
          <div
            className="w-full border my-6"
            style={{ borderColor: COLORS.lightBlueGray }}
          />
          ...
          <ul className="flex flex-col gap-6 list-inside list-disc">
            {description.map((text, index) => (
              <li
                key={index}
                className="text-base font-normal leading-7 tracking-[0.1px]"
                style={{ color: COLORS.darkBlue1 }}
              >
                {text}
              </li>
