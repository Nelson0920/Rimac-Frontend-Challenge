...
const CardPlan: React.FC<TProps> = ({
  ...
  const discountedPrice = selectedOption === 2 ? price * 0.95 : price;

  return (
    <div className=" flex flex-wrap items-start gap-8 relative">
      <div
        ...
        <div className="flex-1">
          <div className="w-full grid grid-cols-[1fr_56px] items-start gap-4">
            <div className="flex flex-col text-grayBlue">
              <p className="text-2xl font-bold leading-8 tracking-[-0.2px] text-darkBlue1">
                {name}
              </p>
              <p className="text-xs font-extrabold leading-4 tracking-[0.6px] uppercase mt-6 mb-1">
                COSTO DEL PLAN
              </p>

              {selectedOption === 2 && (
                <p className="text-[14px] leading-4 tracking-[0.6px] mb-2 line-through">
                  ${price} antes
                </p>
              )}

              <span className="text-xl font-bold leading-7 tracking-[-0.2px] text-darkBlue1">
          ...
          <div className="w-full border my-6 border-lightBlueGray" />
